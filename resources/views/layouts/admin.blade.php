...
<body>
    ...
    <div id="sidebar" class="sidebar d-flex flex-column p-3">
        ...
        <h4 class="sidebar-logo mb-4">
            <a href="{{ auth()->user()->role === 'dietitian' ? route('dietitian.dashboard') : route('admin.dietitianindex') }}"
                class="sidebar-logo-text text-decoration-none">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            @if ($role === 'dietitian')
                <li class="nav-item">
                    <a href="{{ route('dietitian.dashboard') }}" class="nav-link">
