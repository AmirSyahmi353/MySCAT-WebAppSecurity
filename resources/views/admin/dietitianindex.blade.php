            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        @forelse ($dietitians as $d)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('admin.dietitians.destroy', $d->id) }}" method="POST"
                                        class="d-inline" onsubmit="return confirm('Delete this dietitian?');">
                                        @csrf
                                        @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center text-muted">No dietitians found.</td>
                            </tr>
                        @endforelse
                    </tbody>
